class ClapatWebGL {
    ...
    resize() {
        ...
        this.height / this.width > this.imageAspect ? (e = this.width / this.height * this.imageAspect,
        t = 1) : (e = 1,
    ...
    addObjects() {
        let e = (new THREE.TextureLoader).load(jQuery("#showcase-slider-holder").attr("data-pattern-img"));
